<template>
  <div class="about">
    <h2>Кастомизированный компонент Vue2DropdownItem</h2>
    ...
    <div class="section">
      ...
      <div>
        ...
        пунтктов, слева имеет увеличенный паддинг, следующему за иконкой тексту
        добавляется левый отступ. См.<router-link to="/navbar"
          >NavBar</router-link
        >
      </div>
      <pre>
