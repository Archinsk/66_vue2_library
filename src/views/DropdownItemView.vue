<template>
  <div class="about">
    <h2>Кастомизированный Bootstrap компонент BS46DropdownItem</h2>
    <div class="section">
      <vb-alert theme-color="success"
        >Новый элемент. Ранее в проектах не использовался</vb-alert
      >
      <h3>Описание</h3>
      <div>Назначение: пункт выпадающего списка</div>
      <div>
        ...
        vb-offcanvas и панели navbar-expand пункт меняет свою высоту,
        подстраиваясь под высоту основных пунтктов, слева имеет увеличенный
        паддинг, следующему за иконкой тексту добавляется левый отступ.
        См.<router-link to="/navbar">NavBar</router-link>
      </div>
      <pre>
props: {
  type: String,
  ...
  icon: [Object, String],
      ...
      <vb-dropdown-item type="a" href="https://ya.ru">Яндекс</vb-dropdown-item>
      ...
      <vb-dropdown-item type="a" href="#" @click="returnedEvent = 'click'"
        >Пустая ссылка</vb-dropdown-item
      >
...
export default {
  ...
  components: { VbDropdownItem, VbAlert },
  data() {
    return {
      returnedEvent: null,
    };
